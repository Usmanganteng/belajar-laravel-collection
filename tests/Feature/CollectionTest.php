...
class CollectionTest extends TestCase
{
    ...
    {
        $collection = collect(["Aldizar"]);
        $result = $collection->mapInto(Person::class);
        $this->assertEquals([new Person("Aldizar")], $result->all());
    }
    ...
    public function testMapSpread()
    {
        ...
        $this->assertEquals([
            new Person("Aldizar Ilham"),
            new Person("Lulu Salsabila"),
        ], $result->all());
    }
    ...
    public function testCombine()
    {
        ...
        $collection2 = collect(["Aldizar", "Indonesia"]);
    ...
    {
        $collection = collect(["Aldizar", "Ilham", "Ilham"]);

        $this->assertEquals("Aldizar-Ilham-Ilham", $collection->join("-"));
        $this->assertEquals("Aldizar-Ilham_Ilham", $collection->join("-", "_"));
        $this->assertEquals("Aldizar, Ilham and Ilham", $collection->join(", ", " and "));
    }
    ...
    {
        $collection = collect(["Aldizar", "Ilham", "Muhamad"]);
        $this->assertTrue($collection->contains("Aldizar"));
        $this->assertTrue($collection->contains(function ($value, $key) {
            return $value == "Muhamad";
        }));
    }
